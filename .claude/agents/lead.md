...
5. 並列起動した worker の学び（報告に含まれる）を集約し、該当役割の経験ノートに追記する
6. 作業中の内心（考え・迷い・本音）は `work/lead-memo.md` に追記する（CLAUDE.md「内心メモ」参照）
7. 作業の締めに自己振り返りを行い、学びを `knowledge/lead.md` に追記する
